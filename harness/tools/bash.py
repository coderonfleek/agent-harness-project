...
# set of tools.
ALLOW_LIST: set[str] = {"ls", "cat", "wc", "grep", "python", "python3"}
...
def bash(command: str) -> str:
    ...
    Commands are subject to the allow-list and deny-list policy defined at the top of 
    this module. If the policy refuses a command, an error
